...
class MultipleDropdown extends React.Component {
    constructor(props) {
        ...
        map(person => {
            ...
            this.state.optionsPerUserId[person._id] = {
                ...
                image: <Gravatar email={`${person.username}@houlgatefest.com`} rating="pg" default="retro" />
            };
        ...
        function updateBed(bed, index) {
            ...
            if (index !== updatedBedIndex) {
                ...
                if (oldSelection !== "") {
                    ...
                    // the default value.
                    availablePersons = filter(person => newSelection !== person, bed.availablePersons);
                }
            } else {
    ...
    submit(event) {
        ...
        this.props.onSubmit(slice(1, this.state.beds.length, map(bed => bed.selected, this.state.beds)));
    ...
    render() {
        ...
        const submitDisabled = includes("", map(bed => bed.selected, this.state.beds));
